...
$body = Element("8chan/claim.html", array("config" => Vi::$config, "delete" => $delete));
file_write("claim.html", Element("page.html", array("config" => Vi::$config, "body" => $body, "title" => _("Claim"), "subtitle" => _("Take deserted boards back from their owners"))));
