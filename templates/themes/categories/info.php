...
$theme['description'] = 'Group-ordered, category-aware modification of the Frameset theme, with removable sidebar frame.<br/>Requires Vi::$config[\'categories\'].';
$theme['version'] = 'v0.3';
	...
	function categories_install($settings) {
		if (!isset(Vi::$config['categories'])) {
			return Array(false, '<h2>Prerequisites not met!</h2>' .
				'This theme requires Vi::$config[\'boards\'] and Vi::$config[\'categories\'] to be set.');
		}
	}
}
