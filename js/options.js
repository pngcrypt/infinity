...
(function() {
	...
	Options.add_tab = function(id, icon, name, content) {
		...
		tab.content = $("<div class='options_tab "+ id +"'/>").css("display", "none");
	...
	options_close = $("<a id='options_close' href='javascript:void(0)'><i class='fa fa-times'></i></div>").on("click", Options.hide).appendTo(options_div);
